## Ubiatar Team Develop Instructions

Use Node Version > 8.9.0
Install yarn globally (npm i yarn -g)
Install node_modules with yarn (yarn install) inside root folder, packages/material-ui and packages/material-ui-icons
